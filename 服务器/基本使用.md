...
![image-20220208141107602](F:\learn\note book\服务器\Untitled.assets\image-20220208141107602.png)
...
```shell
wget –O /etc/yum.repos.d/jenkins.repo http://pkg.jenkins-ci.org/redhat-stable/jenkins.repo#这里需要查看目录安装的对不对
...
![image-20220208182620595](F:\learn\note book\服务器\Untitled.assets\image-20220208182620595.png)

![image-20220208182547963](F:\learn\note book\服务器\Untitled.assets\image-20220208182547963.png)
...
![image-20220208182841834](F:\learn\note book\服务器\Untitled.assets\image-20220208182841834.png)





![image-20220208182936962](F:\learn\note book\服务器\Untitled.assets\image-20220208182936962.png)
...
![image-20220208211201951](F:\learn\note book\服务器\基本使用.assets\image-20220208211201951.png)
...
![image-20220208211926982](F:\learn\note book\服务器\基本使用.assets\image-20220208211926982.png)
...
```ssh
ssh root@39.105.181.49

```

+ 添加到配置文件（这个应该随意)

![image-20220208184711815](F:\learn\note book\服务器\Untitled.assets\image-20220208184711815.png)



![image-20220208185738104](F:\learn\note book\服务器\Untitled.assets\image-20220208185738104.png)
...
![image-20220208203213354](F:\learn\note book\服务器\基本使用.assets\image-20220208203213354.png)
...
>
>**c/user/.ssh/known_hosts**

二号解决方案

>直接在用户文件夹创建一个文件夹nginx.ssh
>
>**c/user/nginx.ssh/config**
>
>并在vscode中设置ssh的位置

![image-20220208204103470](F:\learn\note book\服务器\基本使用.assets\image-20220208204103470.png)
